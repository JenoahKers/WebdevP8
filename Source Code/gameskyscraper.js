...
var myGameArea = {
    ...
    start : function(){
        ...
        var startScreen = new Image(100, 500);
        startScreen.src = "Art/StartScreenSky.png";

        startScreen.onload = function(){
            myGameArea.context.drawImage(startScreen, 10, 50, 100, 500);
        }
    }
}
...
var player = {
    ...
    y:myGameArea.canvas.height+175,
    speed: 20
};
...
function endGame(){
    var winScreen = new Image(100, 500);
    winScreen.src = "Art/WinScreenSky.png";

    myGameArea.context.drawImage(winScreen, 10, 50, 100, 500);
}
